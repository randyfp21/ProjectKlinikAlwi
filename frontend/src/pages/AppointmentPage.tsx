...
export const AppointmentPage: React.FC = () => {
  ...
  const [appointments, setAppointments] = useState<Appointment[]>([
    ...
    },
    {
      ...
      queue_number: 1,
      status: 'Completed',
      complaint: 'Badan lemas dan sering merasa haus',
    ...
    },
    {
      ...
      queue_number: 3,
      status: 'Completed',
      complaint: 'Batuk kering & demam',
      notes: 'Pemeriksaan ISPA',
    ...
    },
    {
      ...
      patient_id: 7,
      patient: { id: 7, patient_number: 'PAT-007', full_name: 'Bambang Utomo', gender: 'Male', age: 52, phone: '+628133', national_id: '3171012345670007', birth_date: '', address: '', email: '', blood_type: '', allergy: '', disease_history: '', current_complaint: '', emergency_contact: '' },
      doctor_id: 1,
      doctor: { id: 1, user_id: 3, doctor_code: 'DOC-001', name: 'dr. Alwi Shahab, Sp.PD', specialization: 'Internal Medicine', gender: 'Male', phone: '', email: '', practice_license_number: '', education: '', practice_room: 'Room 101', active_status: true },
      ...
      queue_number: 2,
      status: 'Completed',
      complaint: 'Tengkuk pegal sesudah makan',
      notes: 'Cek Kolesterol',
    ...
    },
    {
      ...
      patient_id: 9,
      patient: { id: 9, patient_number: 'PAT-009', full_name: 'Hendra Wijaya', gender: 'Male', age: 34, phone: '+628144', national_id: '3171012345670009', birth_date: '', address: '', email: '', blood_type: '', allergy: '', disease_history: '', current_complaint: '', emergency_contact: '' },
      doctor_id: 1,
      doctor: { id: 1, user_id: 3, doctor_code: 'DOC-001', name: 'dr. Alwi Shahab, Sp.PD', specialization: 'Internal Medicine', gender: 'Male', phone: '', email: '', practice_license_number: '', education: '', practice_room: 'Room 101', active_status: true },
      ...
      queue_number: 1,
      status: 'Completed',
      complaint: 'Gatal-gatal di lengan kanan',
      notes: 'Dermatitis Alergi',
    ...
    },
    {
      ...
      patient_id: 10,
      patient: { id: 10, patient_number: 'PAT-010', full_name: 'Maya Indah', gender: 'Female', age: 27, phone: '+628111', national_id: '3171012345670010', birth_date: '', address: '', email: '', blood_type: '', allergy: '', disease_history: '', current_complaint: '', emergency_contact: '' },
      doctor_id: 1,
      doctor: { id: 1, user_id: 3, doctor_code: 'DOC-001', name: 'dr. Alwi Shahab, Sp.PD', specialization: 'Internal Medicine', gender: 'Male', phone: '', email: '', practice_license_number: '', education: '', practice_room: 'Room 101', active_status: true },
      ...
      queue_number: 2,
      status: 'Completed',
      complaint: 'Wajah pucat dan sering pusing',
      notes: 'Anemia Checkup',
