...
export const LandingPage: React.FC = () => {
  ...
  const { clinicName, clinicTagline, clinicLogoIcon, heroTitle, heroSubtitle, heroBadge, galleryHeaderTitle, galleryHeaderSubtitle, doctorsHeaderTitle, doctorsHeaderMainTitle, doctorsHeaderSubtitle, promosHeaderTitle, facilities, featuredDoctors, galleryPhotos, promos, contactPhone, contactEmail, contactInstagram, clinicAddress } = cms;
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans transition-colors">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto w-full space-y-12">
        ...
        {/* VIEW ALL PROMOS & ARTICLES BUTTON WITH MODERN GLOW EFFECT */}
        <div className="text-center pt-8 flex flex-col items-center justify-center">
          ...
          <p className="text-[11px] text-slate-400 dark:text-slate-500 mt-2.5 font-medium flex items-center gap-1">
            ✨ Dapatkan potongan diskon hingga 35% & informasi medis terpercaya dari dokter spesialis
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-slate-100/70 dark:bg-slate-900/40 border-t border-b border-slate-200 dark:border-slate-800 transition-colors">
        <div className="max-w-7xl mx-auto space-y-12">
          <div className="text-center space-y-3">
            ...
            <h2 className="text-3xl font-black text-slate-900 dark:text-white max-w-3xl mx-auto leading-tight">
