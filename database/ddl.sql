...
CREATE TABLE clinic_cms_settings (
    ...
    doctors_header_subtitle TEXT DEFAULT 'Ditangani Oleh Dokter Spesialis Berpengalaman. Setiap pasien mendapatkan perawatan medis terbaik dari dokter spesialis profesional berlisensi resmi dengan standar pelayanan ramah dan tepat.',
