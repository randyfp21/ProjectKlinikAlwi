...
CREATE TABLE clinic_cms_settings (
    ...
    gallery_header_title VARCHAR(255) DEFAULT 'Klinik Modern & Terpercaya Untuk Keluarga Anda',
    gallery_header_subtitle TEXT DEFAULT 'Memberikan pelayanan medis terbaik dengan tim dokter spesialis berpengalaman dan fasilitas kesehatan modern lengkap.',
    doctors_header_title VARCHAR(255) DEFAULT 'TIM DOKTER SPESIALIS UNGGULAN',
    doctors_header_main_title VARCHAR(255) DEFAULT 'Ditangani Oleh Dokter Spesialis Berpengalaman',
    doctors_header_subtitle TEXT DEFAULT 'Setiap pasien mendapatkan perawatan medis terbaik dari dokter spesialis profesional berlisensi resmi dengan standar pelayanan ramah dan tepat.',
    promos_header_title VARCHAR(255) DEFAULT 'PROMO & ARTIKEL KESEHATAN BERLANGSUNG',
